               ...
               <form action="<?= base_url('auth/save'); ?>" method="post">
                  ...
                  <div class="form-group">
                   ...
                   <div class="form-group">
                       ...
                       <input type="password" class="form-control" name="cpassword" placeholder="Retype password" value="<?= set_value('cpassword'); ?>">
                   ...
                   <br>
                   <a href="<?= site_url('auth'); ?>">I already have an account, Sign In now</a>
               </form>
           </div>
       </div>  
   </div>
