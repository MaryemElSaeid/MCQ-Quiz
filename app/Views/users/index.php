                                ...
                                <tr style="text-align:center;">
                                    ...
                                    <td class="d-flex justify-content-around">
                                        ...
                                        <form action="<?= base_url('user/delete/'.$row['id'])?>" method="POST">
                                            ...
                                            <button type="submit" class="btn btn-danger btn-sm" onclick="return confirm('Are you sure you want to delete this user ?, Warning : Deleting this user will delete all his/her related data!')">Delete</button>
                                        </form>
